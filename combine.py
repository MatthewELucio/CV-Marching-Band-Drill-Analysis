# demo paths:
# /home/mlucio/Documents/CS/yolov5/demo/ellipse.mp4
# /home/mlucio/Documents/CS/yolov5/demo/horizontal.mp4
                    ...
                    for *xyxy, conf, cls in reversed(det):
                        if save_img or save_crop or view_img:  # Add bbox to image
                            ...
                            if transformation == "numbers":
                                ...
                                y = int(height)
                                center = (x, y)
                                #cv2.circle(im0, center, radius = 2, color = (0, 0, 0), thickness = 3, lineType=cv2.LINE_AA)
                                if x > 300 and x < 690:
                                    ud = b_50 + m_50 * x - y
                            ...
                            if transformation == "marchers":
                                cv2.circle(im1, center, radius = 2, color = (0, 0, 0), thickness = 1, lineType=cv2.LINE_AA)
                            elif transformation == "yardnumbers":
                                if names[c] == "50":
                                    x_50 += (x + width)/2
                                    y_50 += (y + height)/2
                        ...
                        if len(ellipse_x) > 10:
                            ...
                            if x0 != None:
                                ...
                                if total/len(ellipse_x) < 60000000:
                                    cv2.ellipse(im0, ((x0, y0), (2 * ap, 2 * bp), -1 * phi), (0, 255, 255), 2)
